        ...
        <div class="h-screen w-screen bg-gray-200 flex flex-col-reverse sm:flex-row min-h-0 min-w-0 overflow-hidden">
            ...
            <main class="sm:h-full flex-1 flex flex-col min-h-0 min-w-0 overflow-auto">
                ...
                <section class="flex-1 pt-3 md:p-6 lg:mb-0 lg:min-h-0 lg:min-w-0">
                    <form action="sendtolist" method="post">
                        @csrf
                                                    ...
                                                    <div class="w-full">
                                                        <div class="text-sm font-medium text-gray-900 w-full">
                                                            ...
                                                            <div class="relative text-gray-600 w-full">
                                                                ...
                                                                <select name="teste" id="teste" class="rounded-full w-5/6">
                                                                    @foreach($lista as $is )
                                                                        <option data-Grupo="{{$is->id}}"  value="{{$is->id}}">{{$is->name}} </option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
            ...
            <div class="relative px-4 min-h-screen md:flex md:items-center md:justify-center">
                ...
                <div class="bg-white rounded-lg md:max-w-md md:mx-auto p-4 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative">
                    ...
                    <div class="text-center md:text-center mt-4 md:flex md:justify-center">
                        <a href="/sendlist"><button class="ml-3 block w-full md:inline-block md:w-auto px-4 py-3 md:py-2 bg-green-200 text-green-700 rounded-lg font-semibold text-sm md:ml-2 md:order-2">
                                OK</button></a>
                    </div>
                </div>
            </div>
