                                                    ...
                                                    <div class="w-full">
                                                        <div class="text-sm font-medium text-gray-900 w-full">
                                                            ...
                                                            <div class="relative text-gray-600 w-full">
                                                                <input  type="text" name="name" placeholder="Nome da lista" class="w-full bg-white h-10 px-5 pr-10 rounded-full text-sm focus:outline-none">
                            ...
                            <div class="border h-full w-full lg:flex-1 px-3 min-h-0 min-w-0">
                                ...
                                <div class="bg-gray-100 w-full h-full min-h-0 min-w-0 overflow-auto rounded-lg rounded-tl-none">
                                    ...
                                    <div class="right-20 fixed bg-red-300 rounded-2xl  " >
                                        <div class="p-4">
                                           Adicionar os números separados por virgula ou ponto e virgula (Exemplo: 91XXXXXXX,911000000)
                                        </div>
                                    </div>
                ...
                <div class="bg-white rounded-lg md:max-w-md md:mx-auto p-4 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative">
                    <div class="md:flex items-center">
                        ...
                        <div class="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
                            <p class="font-bold">lista Adicionada
                            </p>
                            <p class="text-sm text-gray-700 mt-1">A lista de contactos foi adicionada
                            </p>
                        </div>
                    </div>
                    <div class="text-center md:text-center mt-4 md:flex md:justify-center">
                        <a href="/lista"><button class="ml-3 block w-full md:inline-block md:w-auto px-4 py-3 md:py-2 bg-green-200 text-green-700 rounded-lg font-semibold text-sm md:ml-2 md:order-2">
                                OK</button></a>
                    </div>
                </div>
            </div>
