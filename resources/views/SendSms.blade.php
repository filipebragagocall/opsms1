...
{{--                                                    <b>{{$dados['id']}}</b>--}}
                                                    <div class="relative text-gray-600 w-full">
                                                        <input  maxlength="9" type="text" name="phone" placeholder="Número de telefone" class="w-full bg-white h-10 px-5 pr-10 rounded-full text-sm focus:outline-none">
            ...
            <div class="relative px-4 min-h-screen md:flex md:items-center md:justify-center">
                ...
                <div class="bg-white rounded-lg md:max-w-md md:mx-auto p-4 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative">
                    ...
                    <div class="text-center md:text-center mt-4 md:flex md:justify-center">
                        <a href="/sendSMS"><button class="ml-3 block w-full md:inline-block md:w-auto px-4 py-3 md:py-2 bg-green-200 text-green-700 rounded-lg font-semibold text-sm md:ml-2 md:order-2">
                            OK</button></a>
                    </div>
                </div>
            </div>
