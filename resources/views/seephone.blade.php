...
<script>
    ...
    function myFunction() {
        setInterval(function(){ location.replace("/phone"); }, 20000);
    }
</script>
@if (!Auth::guest())
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider flex items-end">
                                    <a href="/phone" class="text-right w-full">
                            ...
                            @if (count($teste) === 0)
                                <tr>
                                    ...
                                    <b>Não tem números adicionados.</b>
                                    </td>
                                </tr>
                            @endif
                            ...
                            @foreach($teste as $testes)
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900"> <b>{{$testes->phone_number}}</b></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 " colspan="2">
                                        <a href="delphone/{{$testes->id}}">
                                        <i class="ml-4 fas fa-trash fill-current"></i>
                                        </a>
                                    </td>
